...
//**********************************************************************************************
	...
	var windowsWidth = $(window).width() - 500;
	...
	var navTitles=['home','about','exec.','team','vision','history','tech','contact'];
	...
	$('a').click(function(){
		if($(this).attr('rel')=='ConcentLink'){
			...
			if(params.CSSstyles==true){
				$('.'+params.AscensorName+'NavigationButton').removeClass(params.NavActiveClass);
				$('.'+params.AscensorName+'NavigationButton:eq('+params.WindowsOn+')').addClass(params.NavActiveClass);
			}
...
//**********************************************************************************************
	...
	if(params.Navig==true){
		...
		$(node).children('div').each(function(index) {
			$('#'+params.AscensorName+'Navigation').append('<dt class="'+params.AscensorName+'NavigationButton nav '+params.AscensorName+'NavigationButton'+index+'" ><a href="javascript:;" title="" id="'+params.AscensorName+'NavigationButton'+index+'">'+navTitles[index]+'</a></dt>').find('dt:eq('+params.WindowsOn+')').addClass(params.NavActiveClass);
			resultatNav+='&lt;dt class="'+params.AscensorName+'NavigationButton nav" &gt;&lt;a href="#" title="" id="'+params.AscensorName+'NavigationButton'+index+'"&gt;&lt;/a&gt;&lt;/dt&gt;</br>';
		})
...
//		$('#'+params.AscensorName+'Navigation dt:eq('+params.WindowsOn+')').css({'background': params.DefNavColor});
	...
	$('.'+params.AscensorName+'NavigationButton').click(function(){
    	...
    	if(params.CSSstyles==true){
			$('.'+params.AscensorName+'NavigationButton').removeClass(params.NavActiveClass);
			$(this).addClass(params.NavClass).addClass(params.NavActiveClass);
		}
    });
...
//**********************************************************************************************
	...
	if(params.PrevNext==true){
		$(node).append('<a id="'+params.AscensorName+'Prev" href="?">prev</a><a id="'+params.AscensorName+'Next" href="?">next</a>');
	}
